...
class Tweet extends React.Component{ 
    ...
    componentDidMount = () => {
        ...
        const url = "https://tweet-app-function.azurewebsites.net/api/getTweets?code=liPwM5RVQH973VUaH2La7wMoQUEBv7U/NM6Ch08jAtdAK3a7Chdn6A==&userID="+this.props.userID;
        ...
        fetch(url).then(res => res.json()).then(data => this.setState({tweets: data})); 
